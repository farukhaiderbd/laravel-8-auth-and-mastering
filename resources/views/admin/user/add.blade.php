                ...
                <div class="main-body">
                    <div class="page-wrapper">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                  <form class="" action="{{url('admin/user/submit')}}" method="post" enctype="multipart/form-data">
                                      @csrf
                                      <div class="card-header">
                                        <div class="row">
                                          ...
                                          <div class="col-md-4 text-right">
                                            <a href="{{url('admin/user')}}" class="btn btn-primary btn-sm"><i class="fa fa-th"></i>All User</a>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="card-body">
